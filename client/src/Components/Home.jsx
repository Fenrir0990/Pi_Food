        ...
        <div className="backgraund">
            ...
            <div className="firstContainer">
                <form action="submit">
                    ...
                    <input className="Buscador" type="search" value={buscar} name="Busca" onChange={(q) => Change(q)} ></input>
                    <button  type="submit" onClick={(q) => Submit(q)}>Go!</button>
                </form>
                ...
                <button onClick={()=>{onlyDb()}}>Only Create Diets</button>
